...
// AUTO-GENERATED from tools/AssetPathDump/assets.txt (BP_FlyingBroomCapsule* — the rideable broom
// actor classes; the player attaches to one of these). APPEND-ONLY: wire mount ids are 1-based indices
